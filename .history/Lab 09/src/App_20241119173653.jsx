...
function App() {
  ...
  const [sortOption, setSortOption] = useState('alphabetical'); // Options: 'alphabetical', 'population', 'area'
  ...
  const filteredCountries = countries
    .filter((country) => {
      if (filterContinent) {
        return country.continents && country.continents.includes(filterContinent);
      }
      if (filterSubregion) {
